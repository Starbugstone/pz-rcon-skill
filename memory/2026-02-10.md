...
- Ambient 5-minute process directive from Stone: keep it fully in-game GM/lore broadcast mode (no Kryten DM-style direct-address assistant tone); request-handler voice and ambient voice remain intentionally split.
